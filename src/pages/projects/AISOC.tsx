      ...
      <section className="relative hero-gradient py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          <motion.div
            ...
            className="max-w-4xl"
          >
            <div className="inline-block px-4 py-1.5 rounded-full bg-secondary/20 text-secondary-foreground font-bold text-sm tracking-widest uppercase mb-4 backdrop-blur-sm border border-secondary/30">
              Featured Project
            </div>
